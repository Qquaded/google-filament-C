...
void Filament_RenderableManager_BuilderInstances(RenderableManager::Builder *builder, size_t instanceCount) {
    builder->instances(instanceCount);
}

void Filament_RenderableManager_BuilderInstances2(RenderableManager::Builder *builder, size_t instanceCount, InstanceBuffer* instanceBuffer) {
